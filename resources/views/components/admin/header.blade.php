<header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
    ...
    <div class="bg-dark text-white d-flex flex-wrap justify-content-center justify-content-lg-start">
        <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
            ...
            <li><a href="{{ route('news') }}" class="nav-link px-2 @if(request()->routeIs('news.*') || request()->routeIs('news')) text-white @else text-secondary @endif">News</a></li>
            ...
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu " aria-labelledby="navbarDarkDropdownMenuLink">
                    <li><a class="dropdown-item" href="{{ route('user.feedback') }}">Feedback</a></li>
